...
class CollectingTask extends Model {
  static CollectingTask of(
    BuildContext context, {
    bool rebuildOnChange = false,
  }) =>
      ScopedModel.of<CollectingTask>(
        context,
  ...
  CollectingTask._fromConnection(this._connection) {
  ...
  static Future<CollectingTask> connect(
      BluetoothDevice server) async {
    final BluetoothConnection connection =
        await BluetoothConnection.toAddress(server.address);
    return CollectingTask._fromConnection(connection);
  }
