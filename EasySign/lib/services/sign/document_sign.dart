...
encryptSygnature(listOfIds) {
  ...
  //Permet de chiffrer une liste donnée
  var encrypted = encrypter.encrypt(listOfIds.join(','), iv: iv);
  return encrypted.base64;
}

decryptSignature(signatureToDecrypt) {
  //Permet de déchiffrer un object chiffré
...
decryptSignature64(signatureToDecrypt64) {
  //Permet de permet de déchiffrer une signature
