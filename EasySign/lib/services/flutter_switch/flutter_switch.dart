...
class FlutterSwitch extends StatefulWidget {
  ...
  const FlutterSwitch({
    ...
    this.disabled = false,
    required this.toggleSizeWidth,
    required this.toggleSizeHeight,
  })  : assert(
  ...
  final double toggleSizeWidth;
  final double toggleSizeHeight;
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      child: Align(
                        ...
                        child: Container(
                          width: widget.toggleSizeWidth,
                          height: widget.toggleSizeHeight,
